...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <div class="header_img"> <img src="4.jpg" alt=""> </div>
    </header>
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Student <br>Information <br> Management <br>System</span> </a>
                <div class="nav_list"> 
                ...
                <i class="fas fa-home nav_icon"></i> 
                      ...
                      <a href="student-create.php" class="nav_link"> 
                          <i class="fas fa-user-plus nav_icon"></i> 
            ...
            <a href="#" class="nav_link" id="log_out"> 
